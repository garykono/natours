(() => {
  ...
  var displayMap = (locations) => {
    var map2 = L.map("map", { zoomControl: false });
    ...
    locations.forEach((loc) => {
      ...
      L.marker([loc.coordinates[1], loc.coordinates[0]]).addTo(map2).bindPopup(`<p>Day ${loc.day}: ${loc.description}</p>`, { autoClose: false }).openPopup();
    });
