...
//         // File extension (mimetype: 'image/jpeg', shown in multer data put in the request)
...
exports.resizeUserPhoto = catchAsync(async (req, res, next) => {
    ...
    // By default, resize will crop image to this size from the image's center
...
exports.deleteOldUserImages = catchAsync(async (req, res, next) => {
    const user = await User.findById(req.user.id);

    const coverPath = `public/img/users/${user.photo}`;
